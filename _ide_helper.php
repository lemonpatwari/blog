 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \App\Mixins\ResponseMixin::withError()
         * @param mixed $error
         * @static 
         */ 
        public static function withError($error)
        {
                        return \Illuminate\Routing\ResponseFactory::withError($error);
        }
                    /**
         * 
         *
         * @see \App\Mixins\ResponseMixin::withSuccess()
         * @param string $message
         * @param mixed $data
         * @static 
         */ 
        public static function withSuccess($message, $data = null)
        {
                        return \Illuminate\Routing\ResponseFactory::withSuccess($message, $data);
        }
